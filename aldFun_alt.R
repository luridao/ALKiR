aldFun_alt <- function(alkframe, slag, drift, drift_age_borrow, drift_lgd_borrow, drift_vekt_borrow, arma, oeki)
{
...
A = lgdvektFun_alt(lgdvektAll, Slag, Drift, Drift_Lgd_Borrow, Drift_Vekt_Borrow, ArmaAld, Oeki)['a']
B = lgdvektFun_alt(lgdvektAll, Slag, Drift, Drift_Lgd_Borrow, Drift_Vekt_Borrow, ArmaAld, Oeki)['b']
...
#aldFun_alt( alkFun(alkAll, lgdAll, Slag, Drift, Drift_Age_Borrow, Drift_Lgd_Borrow, Arma, Oeki), Slag, Drift, Drift_Age_Borrow, Drift_Lgd_Borrow, Drift_Vekt_Borrow, Arma, Oeki ) 
