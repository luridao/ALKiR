...
alkFun_alt <- function(alkall, lgdall, slag, drift, drift_age_borrow, drift_lgd_borrow, arma, oeki)
{
...
#alkFun_alt(alkAll, lgdAll, Slag, Drift, Drift_Age_Borrow, Drift_Lgd_Borrow, Arma, Oeki)
