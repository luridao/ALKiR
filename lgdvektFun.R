...
lgdvektFun <- function(lgdvektall, slag, drift, drift_lgd_borrow, drift_vekt_borrow, arma, oeki)
{
...
#lgdvektFun(lgdvektAll, Slag, DriftV, Drift_Lgd_Borrow, Drift_Vekt_Borrow, Arma, Oeki)
